...
function [] = run_prepro(WhichProject,WhichSessScan,subject,smoothing,discard,slicetime,despike,detr,intnorm,bandpass,demean)
    ...
    switch cfg.WhichProject
        case 'OCDPG'
            run('studies/OCDPG_config.m');
        case 'UCLA'
            run('studies/UCLA_config.m');
        case 'UCLA_native_MNI'
            run('studies/UCLA_native_MNI_config.m');
        case 'NYU_2'
            run('studies/NYU_2_config.m');
        case 'COBRE'
            run('studies/COBRE_config.m');
        case 'Beijing_Zang'
            run('studies/Beijing_Zang_config.m');
        case 'COBRE_HCTSA'
            run('studies/COBRE_HCTSA_config.m');
        case 'UCLA_HCTSA'
            run('studies/UCLA_HCTSA_config.m');
        case 'NAMIC_HCTSA'
            run('studies/NAMIC_HCTSA_config.m');
        case 'conc_TMS_FMRI'
            run('studies/conc_TMS_FMRI_config.m');
        case 'Activebrains_pre'
            run('studies/Activebrains_pre_config.m');
        case 'TBS_fMRI'
            run('studies/TBS_fMRI_config.m');
        case 'EAT'
            run('studies/EAT_config.m');
        case 'OCDPG_DCM'
            run('studies/OCDPG_DCM_config.m');
    end
